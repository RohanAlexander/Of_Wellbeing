...
#dropping irrelevant variables, transforming or recoding variables, and creating new variables from existing ones.Once the data cleaning is complete, the author can
#start analyzing the selected variables to investigate the research question. This may involve using statistical software or other analytical tools to explore relationships 
